    ...
    87372: function (e, t, r) {
            ...
            let t = {
              ...
              c = {
                ...
                async setItem(e, t, i = {}) {
                  ...
                  o.setItem &&
                    (await f(o.setItem, s, d(t), i), o.watch || n("update", e));
                },
                async setItems(e, t) {
                  await a(e, t, async (e) => {
                ...
                async getMeta(e, t = {}) {
                  ...
                  if (
                    (n.getMeta && Object.assign(s, await f(n.getMeta, i, t)),
                    !t.nativeOnly)
                  ) {
      ...
      var V = Object.defineProperty,
        ...
        J = (e, t) => {
          ...
          if (F) for (var r of F(t)) Z.call(t, r) && G(e, r, t[r]);
          return e;
        },
        Q = (e, t) => B(e, K(t));
      function Y(e) {
        return Q(J({}, e), { level: e?.level || U.level });
      }
      function X(e, t = H) {
      ...
      async function eS(e, t, r, i, n = (0, ey.fromMiliseconds)(Date.now())) {
        ...
        let c = { alg: "EdDSA", typ: "JWT" },
          h = { iss: eI(i.publicKey), sub: e, aud: t, iat: n, exp: n + r },
          l =
            ((s = { header: c, payload: h }),
            (0, e_.m)([eE(s.header), eE(s.payload)].join("."), "utf8"));
        return [
          eE(
            (o = { header: c, payload: h, signature: ed.Xx(i.secretKey, l) })
              .header
          ),
          eE(o.payload),
          ((a = o.signature), (0, eb.B)(a, ev)),
        ].join(".");
      }
      r(43014);
      var eO = r(37466);
      let ex = "INTERNAL_ERROR",
        ...
        eC = {
          ...
          [ex]: { code: -32603, message: "Internal error" },
        ...
        return {
          ...
          error:
            void 0 === (i = t)
              ? eN(ex)
              : ("string" == typeof i &&
                  (i = Object.assign(Object.assign({}, eN(eR)), {
                    message: i,
                  })),
                void 0 !== r && (i.data = r),
                (n = i.code),
                eA.includes(n) &&
                  ((s = i.code),
                  (i = Object.values(eC).find((e) => e.code === s) || eC[eR])),
                i),
        };
      }
      class ek {}
      ...
      class eJ extends eU {
        ...
        async request(e, t) {
          return this.requestStrict(
            eD(e.method, e.params || [], e.id || eL().toString()),
            t
          );
        }
      ...
      class e0 {
        ...
        emitError(e) {
          let t = this.parseError(
            Error(
              e?.message ||
                `WebSocket connection failed for host: ${eY(this.url)}`
            )
          );
      ...
      class tn {
        constructor(e, t, r, i) {
          (this.name = e),
            ...
            (this.baseEncode = r),
            (this.baseDecode = i),
            (this.encoder = new te(e, t, r)),
            (this.decoder = new tt(e, t, i));
        }
        encode(e) {
      ...
      let ts = ({ name: e, prefix: t, encode: r, decode: i }) =>
          new tn(e, t, r, i),
        to = ({ prefix: e, name: t, alphabet: r }) => {
          let { encode: i, decode: n } = e4(r, t);
          return ts({ prefix: e, name: t, encode: i, decode: (e) => e7(n(e)) });
        },
        ta = (e, t, r, i) => {
          let n = {};
        ...
        th = ({ name: e, prefix: t, bitsPerChar: r, alphabet: i }) =>
          ts({
            prefix: t,
            name: e,
            encode: (e) => tc(e, i, r),
      ...
      var tl = Object.freeze({
        ...
        tf = Object.freeze({
          __proto__: null,
          base10: to({ prefix: "9", name: "base10", alphabet: "0123456789" }),
        }),
        td = Object.freeze({
          __proto__: null,
          base16: th({
      ...
      function tC(e, t) {
        ...
        do {
          if (s >= o)
            throw ((tC.bytes = 0), RangeError("Could not decode varint"));
          (r = e[s++]),
      ...
      let tj = (e, t, r = 0) => (tN(e, t, r), t),
        ...
        tq = (e, t) => {
          ...
          return tj(e, s, 0), tj(r, s, i), s.set(t, n), new tL(e, r, t, s);
        };
      class tL {
        constructor(e, t, r, i) {
      ...
      let tD = ({ name: e, code: t, encode: r }) => new tz(e, t, r);
      class tz {
        constructor(e, t, r) {
      ...
      var tk = Object.freeze({
          __proto__: null,
          sha256: tD({ name: "sha2-256", code: 18, encode: tM("SHA-256") }),
          sha512: tD({ name: "sha2-512", code: 19, encode: tM("SHA-512") }),
        }),
        t$ = Object.freeze({
          __proto__: null,
          identity: {
      ...
      let tB = tV(
          ...
          (e) => {
            let t = (function (e = 0) {
              return null != globalThis.Buffer &&
                ...
                ? tH(globalThis.Buffer.allocUnsafe(e))
                : new Uint8Array(e);
        ...
        t7 = {
          wc_pairingDelete: {
            req: { ttl: ey.ONE_DAY, prompt: !1, tag: 1e3 },
            res: { ttl: ey.ONE_DAY, prompt: !1, tag: 1001 },
          },
          wc_pairingPing: {
            req: { ttl: ey.THIRTY_SECONDS, prompt: !1, tag: 1002 },
            res: { ttl: ey.THIRTY_SECONDS, prompt: !1, tag: 1003 },
          },
          unregistered_method: {
            req: { ttl: ey.ONE_DAY, prompt: !1, tag: 0 },
            res: { ttl: ey.ONE_DAY, prompt: !1, tag: 0 },
          },
        },
        t9 = {
        ...
        constructor(e, t, r) {
          (this.core = e),
            ...
            (this.getClientId = async () => (
              this.isInitialized(), eI(eP(await this.getClientSeed()).publicKey)
            )),
            ...
            (this.getPayloadSenderPublicKey = (e) => {
              ...
              return t.senderPublicKey
                ? (0, eO.BB)(t.senderPublicKey, o.AW)
                : void 0;
            }),
            (this.core = e),
            (this.logger = ee(t, this.name)),
            (this.keychain = r || new rs(this.core, this.logger));
        }
        get context() {
          return X(this.logger);
        }
        ...
        async getClientSeed() {
          ...
          return (function (e, t = "utf8") {
            ...
            return ("utf8" === t || "utf-8" === t) &&
              ...
              ? tH(globalThis.Buffer.from(e, "utf-8"))
      ...
      class ra extends en {
        constructor(e, t) {
          super(e, t),
            ...
            (this.has = (e, t) => (
              this.isInitialized(), "u" > typeof this.get(e)[(0, o.rj)(t)]
            )),
            (this.del = async (e) => {
              this.isInitialized(),
      ...
      class rc extends es {
        constructor(e, t) {
          super(e, t),
            ...
            (this.name = "publisher"),
            (this.queue = new Map()),
            (this.publishTimeout = (0, ey.toMiliseconds)(ey.TEN_SECONDS)),
              ...
              try {
                ...
                try {
                  await await (0, o.hF)(
                    ...
                    this.relayer.events.emit(t5.publish, l);
                } catch (e) {
                  if (
      ...
      var rl = Object.defineProperty,
        ...
        rv = (e, t) => {
          ...
          if (rf) for (var r of rf(t)) rg.call(t, r) && ry(e, r, t[r]);
          return e;
        },
        rm = (e, t) => ru(e, rp(t));
      class rw extends ec {
              ...
              (await new Promise((t, r) => {
                ...
                let n = setInterval(() => {
                  !this.pending.has(e) &&
                    ...
                    t(!0)),
                    i.elapsed(this.pendingSubscriptionWatchLabel) >= t4 &&
                      (clearInterval(n),
                      i.stop(this.pendingSubscriptionWatchLabel),
        ...
        onSubscribe(e, t) {
          this.setSubscription(e, rm(rv({}, t), { id: e })),
            this.pending.delete(t.topic);
        }
        onBatchSubscribe(e) {
          e.length &&
            e.forEach((e) => {
              this.setSubscription(e.id, rv({}, e)),
        ...
        addSubscription(e, t) {
          this.subscriptions.set(e, rv({}, t)),
            this.topicMap.set(t.topic, e),
            this.events.emit(t2.created, t);
        }
        getSubscription(e) {
        ...
        deleteSubscription(e, t) {
          ...
          this.subscriptions.delete(e),
            ...
            this.events.emit(t2.deleted, rm(rv({}, r), { reason: t }));
        }
        async persist() {
          await this.setRelayerSubscriptions(this.values),
            this.events.emit(t2.sync);
        }
        async reset() {
        ...
        async batchSubscribe(e) {
          ...
          (0, o.qt)(t) &&
            this.onBatchSubscribe(t.map((t, r) => rm(rv({}, e[r]), { id: t })));
        }
        async onConnect() {
        ...
        registerEventListeners() {
          this.relayer.core.heartbeat.on(M.HEARTBEAT_EVENTS.pulse, async () => {
            ...
            this.events.on(t2.created, async (e) => {
              let t = t2.created;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, data: e }),
                await this.persist();
            }),
            this.events.on(t2.deleted, async (e) => {
              let t = t2.deleted;
              this.logger.info(`Emitting ${t}`),
                this.logger.debug({ type: "event", event: t, data: e }),
                await this.persist();
      ...
      var rb = Object.defineProperty,
        ...
        rP = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        rS = (e, t) => {
          for (var r in t || (t = {})) rE.call(t, r) && rP(e, r, t[r]);
          if (r_) for (var r of r_(t)) rI.call(t, r) && rP(e, r, t[r]);
          return e;
        };
      class rO extends eo {
        constructor(e) {
          super(e),
            ...
            (this.registerProviderListeners = () => {
              this.provider.on(t6.payload, this.onPayloadHandler),
                this.provider.on(t6.connect, this.onConnectHandler),
                this.provider.on(t6.disconnect, this.onDisconnectHandler),
                this.provider.on(t6.error, this.onProviderErrorHandler);
            }),
            (this.core = e.core),
            (this.logger =
              "u" > typeof e.logger && "string" != typeof e.logger
                ? ee(e.logger, this.name)
                : $()(Y({ level: e.logger || "error" }))),
            (this.messages = new ra(this.logger, e.core)),
            (this.subscriber = new rw(this, this.logger)),
            (this.publisher = new rc(this, this.logger)),
            (this.relayUrl = e?.relayUrl || t0),
        ...
        async init() {
          ...
          try {
            ...
            this.logger.warn(
              `Connection via ${this.relayUrl} failed, attempting to connect via failover domain ${t1}...`
            ),
              await this.restartTransport(t1);
          }
          (this.initialized = !0),
            setTimeout(async () => {
        ...
        async subscribe(e, t) {
          ...
          if (n) return n;
          let s = (t) => {
            t.topic === e && (this.subscriber.off(t2.created, s), i());
          };
          return (
            await Promise.all([
              new Promise((e) => {
                (i = e), this.subscriber.on(t2.created, s);
              }),
              new Promise(async (r) => {
            ...
            try {
              await Promise.all([
                new Promise((e) => {
                  ...
                  this.subscriber.once(t2.resubscribed, () => {
                    e();
                  });
                }),
        ...
        async onProviderPayload(e) {
          if (
            ...
            this.logger.debug("Emitting Relayer Payload"),
              this.logger.trace(rS({ type: "event", event: t.id }, s)),
        ...
        async onMessageEvent(e) {
          (await this.shouldIgnoreMessageEvent(e)) ||
            (this.events.emit(t5.message, e), await this.recordMessageEvent(e));
        }
        ...
        unregisterProviderListeners() {
          this.provider.off(t6.payload, this.onPayloadHandler),
            this.provider.off(t6.connect, this.onConnectHandler),
            this.provider.off(t6.disconnect, this.onDisconnectHandler),
            this.provider.off(t6.error, this.onProviderErrorHandler);
        }
      ...
      var rx = Object.defineProperty,
        ...
        rj = (e, t) => {
          ...
          if (rR) for (var r of rR(t)) rC.call(t, r) && rN(e, r, t[r]);
          return e;
        };
      class rT extends ea {
            ...
            (this.getAll = (e) => (
              ...
              e
                ? this.values.filter((t) =>
                    Object.keys(e).every((r) => e5()(t[r], e[r]))
                  )
                : this.values
            )),
        ...
        constructor(e, t) {
          (this.core = e),
            ...
            (this.pair = async (e) => {
              ...
              let { topic: t, symKey: r, relay: i } = (0, o.he)(e.uri);
            ...
            (this.ping = async (e) => {
              ...
              if (this.pairings.keys.includes(t)) {
                let e = await this.sendRequest(t, "wc_pairingPing", {}),
                  { done: r, resolve: i, reject: n } = (0, o.H1)();
                this.events.once(
            ...
            (this.sendResult = async (e, t, r) => {
              let i = ez(e, r),
                ...
                s = t7[(await this.core.history.get(t, e)).request.method].res;
            ...
            (this.sendError = async (e, t, r) => {
              let i = eM(e, r),
                ...
                o = t7[s.request.method]
                  ? t7[s.request.method].res
                  : t7.unregistered_method.res;
            ...
            (this.onPairingPingRequest = async (e, t) => {
              ...
              try {
                this.isValidPing({ topic: e }),
                  ...
                  this.events.emit(t9.ping, { id: r, topic: e });
              } catch (t) {
            ...
            (this.onPairingPingResponse = (e, t) => {
              ...
              setTimeout(() => {
                eZ(t)
                  ? this.events.emit((0, o.E0)("pairing_ping", r), {})
                  : eG(t) &&
                    this.events.emit((0, o.E0)("pairing_ping", r), {
                      error: t.error,
                    });
            ...
            (this.onPairingDeleteRequest = async (e, t) => {
              ...
              try {
                this.isValidDisconnect({ topic: e }),
                  ...
                  this.events.emit(t9.delete, { id: r, topic: e });
              } catch (t) {
                await this.sendError(r, e, t), this.logger.error(t);
              }
            }),
        ...
        registerExpirerEvents() {
          this.core.expirer.on(re.expired, async (e) => {
            ...
            t &&
              ...
              this.events.emit(t9.expire, { topic: t }));
          });
        }
      }
      class rL extends ei {
        ...
        get pending() {
          ...
          return (
            this.values.forEach((t) => {
              ...
              let r = {
                topic: t.topic,
                request: eD(t.request.method, t.request.params, t.id),
                chainId: t.chainId,
              };
              return e.push(r);
            }),
        ...
        cleanup() {
          try {
            this.records.forEach((e) => {
              (0, ey.toMiliseconds)(e.expiry || 0) - Date.now() <= 0 &&
      ...
      class rD extends eh {
          ...
          super(e, t),
            ...
            (this.set = (e, t) => {
              ...
              this.expirations.set(r, i),
                ...
                this.events.emit(re.created, { target: r, expiration: i });
            }),
            (this.get = (e) => {
              this.isInitialized();
              let t = this.formatTarget(e);
            ...
            (this.del = (e) => {
              if ((this.isInitialized(), this.has(e))) {
                ...
                this.expirations.delete(t),
                  this.events.emit(re.deleted, { target: t, expiration: r });
              }
            }),
            (this.on = (e, t) => {
              this.events.on(e, t);
        ...
        expire(e, t) {
          this.expirations.delete(e),
            this.events.emit(re.expired, { target: e, expiration: t });
        }
        checkExpirations() {
          ...
          super(e, t),
            ...
            (this.resolve = async (e) => {
              ...
              try {
                ...
                this.logger.info(
                  ...
                  this.logger.info(i),
                  (t = await this.fetchAttestation(e.attestationId, ri));
              }
              return t;
            }),
            ...
            (this.getVerifyUrl = (e) => {
              ...
              return (
                rn.includes(t) ||
                  (this.logger.info(
                    `verify url: ${t}, not included in trusted list, assigning default: ${rr}`
                  ),
                  (t = rr)),
                t
              );
            ...
            (this.isDevEnv = (0, o.UG)() && e2.env.IS_VITEST);
        }
        get context() {
          return X(this.logger);
        }
      ...
      var rk = Object.defineProperty,
        ...
        rB = (e, t) => {
          ...
          if (r$) for (var r of r$(t)) rH.call(t, r) && rV(e, r, t[r]);
          return e;
        };
      class rK extends er {
        constructor(e) {
          ...
          let t =
            "u" > typeof e?.logger && "string" != typeof e?.logger
              ? e.logger
              : $()(Y({ level: e?.logger || tG.logger }));
          (this.logger = ee(t, this.name)),
            (this.heartbeat = new M.HeartBeat()),
            (this.crypto = new ro(this, this.logger, e?.keychain)),
            (this.history = new rL(this, this.logger)),
            (this.expirer = new rD(this, this.logger)),
            (this.storage =
              null != e && e.storage
                ? e.storage
                : new z(rB(rB({}, tJ), e?.storageOptions))),
            (this.relayer = new rO({
              core: this,
              logger: this.logger,
              relayUrl: this.relayUrl,
            ...
            (this.pairing = new rq(this, this.logger)),
            (this.verify = new rz(this.projectId || "", this.logger)),
            (this.echoClient = new rM(this.projectId || "", this.logger));
        }
        static async init(e) {
          let t = new rK(e);
          await t.initialize();
      ...
      let rF = "client",
        rW = `wc@2:${rF}:`,
        rZ = { name: rF, logger: "error" },
        rG = "WALLETCONNECT_DEEPLINK_CHOICE",
        rJ = "Proposal expired",
        rQ = ey.SEVEN_DAYS,
        rY = {
          wc_sessionPropose: {
            req: { ttl: ey.FIVE_MINUTES, prompt: !0, tag: 1100 },
            res: { ttl: ey.FIVE_MINUTES, prompt: !1, tag: 1101 },
          },
          wc_sessionSettle: {
            req: { ttl: ey.FIVE_MINUTES, prompt: !1, tag: 1102 },
            res: { ttl: ey.FIVE_MINUTES, prompt: !1, tag: 1103 },
          },
          wc_sessionUpdate: {
            req: { ttl: ey.ONE_DAY, prompt: !1, tag: 1104 },
            res: { ttl: ey.ONE_DAY, prompt: !1, tag: 1105 },
          },
          wc_sessionExtend: {
            req: { ttl: ey.ONE_DAY, prompt: !1, tag: 1106 },
            res: { ttl: ey.ONE_DAY, prompt: !1, tag: 1107 },
          },
          wc_sessionRequest: {
            req: { ttl: ey.FIVE_MINUTES, prompt: !0, tag: 1108 },
            res: { ttl: ey.FIVE_MINUTES, prompt: !1, tag: 1109 },
          },
          wc_sessionEvent: {
            req: { ttl: ey.FIVE_MINUTES, prompt: !0, tag: 1110 },
            res: { ttl: ey.FIVE_MINUTES, prompt: !1, tag: 1111 },
          },
          wc_sessionDelete: {
            req: { ttl: ey.ONE_DAY, prompt: !1, tag: 1112 },
            res: { ttl: ey.ONE_DAY, prompt: !1, tag: 1113 },
          },
          wc_sessionPing: {
            req: { ttl: ey.THIRTY_SECONDS, prompt: !1, tag: 1114 },
            res: { ttl: ey.THIRTY_SECONDS, prompt: !1, tag: 1115 },
          },
        },
        rX = { min: ey.FIVE_MINUTES, max: ey.SEVEN_DAYS },
        r0 = { idle: "IDLE", active: "ACTIVE" },
      ...
      var r5 = Object.defineProperty,
        ...
        r9 = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        r8 = (e, t) => {
          for (var r in t || (t = {})) r4.call(t, r) && r9(e, r, t[r]);
          if (r2) for (var r of r2(t)) r7.call(t, r) && r9(e, r, t[r]);
          return e;
        },
        ie = (e, t) => r6(e, r3(t));
      class it extends ef {
        constructor(e) {
          super(e),
            ...
            (this.initialized = !1),
            (this.ignoredPayloadTypes = [o.rV]),
            (this.requestQueue = { state: r0.idle, queue: [] }),
            (this.sessionRequestQueue = { state: r0.idle, queue: [] }),
            (this.requestQueueDelay = ey.ONE_SECOND),
            (this.init = async () => {
              this.initialized ||
                (await this.cleanup(),
                this.registerRelayerEvents(),
            ...
            (this.connect = async (e) => {
              ...
              return (
                await this.setProposal(y, r8({ id: y, expiry: v }, p)),
                { uri: h, approval: g }
              );
            }),
            (this.pair = async (e) => (
            ...
            (this.approve = async (e) => {
              ...
              return (
                ...
                await this.setExpiry(p, (0, o.gn)(rQ)),
                {
                  topic: p,
                  acknowledged: () =>
                    new Promise((e) =>
            ...
            (this.extend = async (e) => {
              ...
              let { topic: t } = e,
                ...
                { done: i, resolve: n, reject: s } = (0, o.H1)();
              return (
                this.events.once(
                  (0, o.E0)("session_extend", r),
                  ({ error: e }) => {
                    e ? s(e) : n();
                  }
                ),
              ...
              return (
                ...
                await Promise.all([
                  ...
                  new Promise(async (e) => {
                    ...
                    (0, o.Hh)({ id: s, topic: i, wcDeepLink: t }), e();
                  }),
                  a(),
                ]).then((e) => e[2])
              );
            ...
            (this.respond = async (e) => {
              ...
              eZ(r)
                ...
                : eG(r) && (await this.sendError(i, t, r.error)),
            ...
            (this.deletePendingSessionRequest = async (e, t, r = !1) => {
              await Promise.all([
                ...
                r && (this.sessionRequestQueue.state = r0.idle);
            }),
            ...
            (this.sendResult = async (e) => {
              let { id: t, topic: r, result: i, throwOnFailedPublish: n } = e,
                ...
                a =
                  rY[(await this.client.core.history.get(r, t)).request.method]
                    .res;
              n
                ? ((a.internal = ie(r8({}, a.internal), {
                    throwOnFailedPublish: !0,
                  })),
            ...
            (this.sendError = async (e, t, r) => {
              let i = eM(e, r),
                ...
                s =
                  rY[(await this.client.core.history.get(t, e)).request.method]
                    .res;
            ...
            (this.onSessionProposeRequest = async (e, t) => {
              ...
              try {
                ...
                let n = (0, o.gn)(ey.FIVE_MINUTES),
                  s = r8({ id: i, pairingTopic: e, expiry: n }, r);
            ...
            (this.onSessionSettleResponse = async (e, t) => {
              ...
              eZ(t)
                ? (await this.client.session.update(e, { acknowledged: !0 }),
                  this.events.emit((0, o.E0)("session_approve", r), {}))
                : eG(t) &&
            ...
            (this.onSessionUpdateRequest = async (e, t) => {
              ...
              try {
                ...
                this.isValidUpdate(r8({ topic: e }, r)),
            ...
            (this.onSessionUpdateResponse = (e, t) => {
              let { id: r } = t;
              eZ(t)
                ? this.events.emit((0, o.E0)("session_update", r), {})
                : eG(t) &&
                  this.events.emit((0, o.E0)("session_update", r), {
                    error: t.error,
                  });
            ...
            (this.onSessionExtendRequest = async (e, t) => {
              ...
              try {
                this.isValidExtend({ topic: e }),
                  await this.setExpiry(e, (0, o.gn)(rQ)),
            ...
            (this.onSessionExtendResponse = (e, t) => {
              let { id: r } = t;
              eZ(t)
                ? this.events.emit((0, o.E0)("session_extend", r), {})
                : eG(t) &&
                  this.events.emit((0, o.E0)("session_extend", r), {
                    error: t.error,
                  });
            ...
            (this.onSessionPingResponse = (e, t) => {
              ...
              setTimeout(() => {
                eZ(t)
                  ? this.events.emit((0, o.E0)("session_ping", r), {})
                  : eG(t) &&
                    this.events.emit((0, o.E0)("session_ping", r), {
                      error: t.error,
                    });
            ...
            (this.onSessionRequest = async (e, t) => {
              let { id: r, params: i } = t;
              try {
                this.isValidRequest(r8({ topic: e }, i));
                let t = (0, o.rj)(
                    JSON.stringify(eD("wc_sessionRequest", i, r))
                  ),
                  n = this.client.session.get(e),
                  s = await this.getVerifyContext(t, n.peer.metadata),
                  a = { id: r, topic: e, params: i, verifyContext: s };
            ...
            (this.onSessionRequestResponse = (e, t) => {
              let { id: r } = t;
              eZ(t)
                ? this.events.emit((0, o.E0)("session_request", r), {
                    result: t.result,
                  })
                : eG(t) &&
                  this.events.emit((0, o.E0)("session_request", r), {
            ...
            (this.cleanupAfterResponse = (e) => {
              this.deletePendingSessionRequest(e.response.id, {
                ...
                setTimeout(() => {
                  (this.sessionRequestQueue.state = r0.idle),
                    this.processSessionRequestQueue();
                }, (0, ey.toMiliseconds)(this.requestQueueDelay));
            }),
            (this.processSessionRequestQueue = () => {
              ...
              try {
                (this.sessionRequestQueue.state = r0.active),
            ...
            (this.isValidRequest = async (e) => {
              ...
              if (n && !(0, o.ON)(n, rX)) {
                let { message: e } = (0, o.Z7)(
                  "MISSING_OR_INVALID",
                  `request() expiry: ${n}. Expiry must be a number (in seconds) between ${rX.min} and ${rX.max}`
                );
                throw Error(e);
              }
            }),
        ...
        registerExpirerEvents() {
          this.client.core.expirer.on(re.expired, async (e) => {
            let { topic: t, id: r } = (0, o.iP)(e.target);
        ...
        registerPairingEvents() {
          this.client.core.pairing.events.on(t9.create, (e) =>
            this.onPairingCreated(e)
          );
        }
      ...
      class io extends ep {
        constructor(e) {
          super(e),
            ...
            (this.name = e?.name || rZ.name),
            (this.metadata = e?.metadata || (0, o.D)());
          let t =
            "u" > typeof e?.logger && "string" != typeof e?.logger
              ? e.logger
              : $()(Y({ level: e?.logger || rZ.logger }));
          (this.core = e?.core || new rK(e)),
            (this.logger = ee(t, this.name)),
            (this.session = new ii(this.core, this.logger)),
            (this.proposal = new ir(this.core, this.logger)),
            (this.pendingRequest = new is(this.core, this.logger)),
            (this.engine = new it(this));
        }
        static async init(e) {
          let t = new io(e);
      ...
      var ia = r(54098),
        ...
        iy = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        iv = (e, t) => {
          for (var r in t || (t = {})) id.call(t, r) && iy(e, r, t[r]);
          if (ip) for (var r of ip(t)) ig.call(t, r) && iy(e, r, t[r]);
          return e;
        },
        im = (e, t) => il(e, iu(t));
      let iw = {
      ...
      class ib {
        ...
        async send(e) {
          ...
          try {
            let t = R(e),
              r = await (
                await ic()(this.url, im(iv({}, iw), { body: t }))
              ).json();
        ...
        async register(e = this.url) {
          ...
          try {
            if (!this.disableProviderPing) {
              let t = R({ id: 1, jsonrpc: "2.0", method: "test", params: [] });
              await ic()(e, im(iv({}, iw), { body: t }));
            }
            this.onOpen();
          } catch (t) {
      ...
      let iE = "error",
        iI = "wc@2:universal_provider:",
        iP = "default_chain_changed";
      var iS =
          "u" > typeof globalThis
            ? globalThis
            : "u" > typeof window
       ...
       */ !(function (e, t) {
        (function () {
          ...
          var eY = {
            ...
            eX = parseFloat,
            e0 = parseInt,
            e1 = "object" == typeof iS && iS && iS.Object === Object && iS,
            e5 =
          ...
          function tB(e) {
            return tM(e) ? e.match(eB) || [] : e.split("");
          }
          function tK(e) {
          ...
          var tF = tS({
            ...
            tW = (function e(t) {
              var Y,
                ...
                ev,
                em = (t =
                  null == t ? e6 : tW.defaults(e6.Object(), t, tW.pick(e6, eZ)))
                  .Array,
                ew = t.Date,
                eb = t.Error,
                e_ = t.Function,
              ...
              function rq(e, t, i, n, s, o) {
                ...
                if (w) {
                  if (
                    ((P = e.length),
                    (D = new e.constructor(P)),
                    P &&
                      "string" == typeof e[0] &&
                      ej.call(e, "index") &&
                      ((D.index = e.index), (D.input = e.input)),
                    (a = D),
                    !c)
                  )
                    return iH(e, a);
                  ...
                  var P,
                    ...
                    $ = nv(e),
                    U = $ == d || $ == g;
                  if (sk(e)) return iD(e, c);
                  if ($ == m || $ == h || (U && !s)) {
                    if (((a = l || U ? {} : nw(e)), !c))
                      return l
                        ? ((z = (k = a) && iV(e, of(e), k)), iV(e, ny(e), z))
                        : ((M = rC(a, e)), iV(e, ng(e), M));
                  } else {
                    if (!eQ[$]) return s ? e : {};
                    a = (function (e, t, r) {
                      var i,
              ...
              function rz(e, t, r, i) {
                ...
                r && (t = tp(t, tC(r))),
                  i
                    ? ((s = tu), (o = !1))
                    : t.length >= 200 && ((s = tj), (o = !1), (t = new rE(t)));
                e: for (; ++n < a; ) {
                  var l = e[n],
                    u = null == r ? l : r(l);
              ...
              function r4(e) {
                return (
                  !(!sK(e) || (eq && eq in e)) && (sH(e) ? eM : eh).test(nk(e))
                );
              }
              function r7(e) {
              ...
              function r9(e) {
                ...
                var t = [];
                for (var r in eI(e))
                  ej.call(e, r) && "constructor" != r && t.push(r);
                return t;
              }
              function r8(e, t) {
                return e < t;
              ...
              function ib(e, t, i, n) {
                ...
                t = i(t);
                for (
                  var a = t != t, c = null === t, h = sX(t), l = t === r;
                  s < o;
              ...
              function iT(e, t) {
                return sL(e) ? e : nI(e, t) ? [e] : nz(s8(e));
              }
              function iq(e, t, i) {
                var n = e.length;
                ...
                return ns(function (t) {
                  ...
                  for (s = c ? s : n; ++s < n; ) {
                    var h = nh((a = t[s])),
                      l = "wrapper" == h ? nc(a) : r;
                    c =
                      l && nP(l[0]) && 424 == l[1] && !l[4].length && 1 == l[9]
                        ? c[nh(l[0])].apply(c, l[3])
                        : 1 == a.length && nP(a)
                        ? c[h]()
                        : c.thru(a);
                  }
              ...
              function iX(e, t, i, n, s, o, a, c, h, l) {
                var u = 128 & t,
                  ...
                  y = f ? r : iJ(e);
                return function v() {
                  for (var m = arguments.length, w = em(m), b = m; b--; )
                    w[b] = arguments[b];
                  if (d)
                    var _ = nl(v),
                      E = (function (e, t) {
                  ...
                  if (
                    ...
                    var I = tU(w, _);
                    return i4(e, t, iX, v.placeholder, i, w, I, c, h, l - m);
                  }
                  var P = p ? i : this,
                    S = f ? P[e] : e;
                  return (
                    ...
                    c
                      ? (w = (function (e, t) {
                          for (
                            var i = e.length, n = t6(t.length, i), s = iH(e);
                            n--;
              ...
              function i6(e, t) {
                ...
                return tM(t) ? iq(tB(n), 0, e).join("") : n.slice(0, e);
              }
              function i3(e) {
                return function (t, i, n) {
                  return (
              ...
              function i7(e) {
                ...
                return function (e, r) {
                  if (
                    ((e = s7(e)), (r = null == r ? 0 : t6(s2(r), 292)) && tX(e))
                  ) {
                    var i = (s8(e) + "e").split("e");
                    return +(
                      (i = (s8(t(i[0] + "e" + (+i[1] + r))) + "e").split(
                        "e"
                      ))[0] +
                      "e" +
                      (+i[1] - r)
                ...
                if (
                  ...
                  8 == t || 16 == t
                    ? ((v = e),
                      ...
                      (j = function e() {
                        for (
                          var t = arguments.length, i = em(t), n = t, s = nl(e);
                          n--;

                        )
                          i[n] = arguments[n];
                        var o =
                          t < 3 && i[0] !== s && i[t - 1] !== s ? [] : tU(i, s);
                        return (t -= o.length) < w
                          ? i4(v, m, iX, e.placeholder, r, i, o, r, r, w - t)
                          : ts(
                      ...
                      (j = function e() {
                        for (
                          var t = -1,
                            ...
                            s = em(n + r),
                            o =
                              this && this !== e6 && this instanceof e ? O : _;
                          ++i < n;
                  ...
                  var v,
                    ...
                    j =
                      ...
                      function e() {
                        return (
                          this && this !== e6 && this instanceof e ? N : x
...
`
              ...
              var nU = ip(function (e, t) {
                  return sM(e) ? rz(e, rV(t, 1, sM, !0)) : [];
                }),
                nH = ip(function (e, t) {
                  var i = nQ(t);
                  return (
                    sM(i) && (i = r),
                    sM(e) ? rz(e, rV(t, 1, sM, !0), nu(i, 2)) : []
                  );
                }),
                nV = ip(function (e, t) {
                  var i = nQ(t);
                  return (
                    sM(i) && (i = r), sM(e) ? rz(e, rV(t, 1, sM, !0), r, i) : []
                  );
                });
              function nB(e, t, r) {
              ...
              function nK(e, t, i) {
                ...
                return (
                  i !== r &&
                    ((s = s2(i)), (s = i < 0 ? t5(n + s, 0) : t6(s, n - 1))),
                  tw(e, nu(t, 3), s, !0)
                );
              }
              function nF(e) {
              ...
              var n5 = ip(function (e) {
                  return iP(rV(e, 1, sM, !0));
                }),
                n6 = ip(function (e) {
                  var t = nQ(e);
                  return sM(t) && (t = r), iP(rV(e, 1, sM, !0), nu(t, 2));
                }),
                n3 = ip(function (e) {
                  var t = nQ(e);
                  return (
              ...
              var n7 = ip(function (e, t) {
                ...
                n8 = ip(function (e) {
                  var t = nQ(e);
                  return sM(t) && (t = r), iA(th(e, sM), nu(t, 2));
                }),
                se = ip(function (e) {
                  var t = nQ(e);
                  return (
                    (t = "function" == typeof t ? t : r), iA(th(e, sM), r, t)
                  );
                }),
                st = ip(n2),
                sr = ip(function (e) {
                  var t = e.length,
                    i = t > 1 ? e[t - 1] : r;
                  return (
                    (i = "function" == typeof i ? (e.pop(), i) : r), n4(e, i)
                  );
                });
              function si(e) {
                var t = rd(e);
              ...
              function sE(e, t, n) {
                ...
                function w() {
                  ...
                  if (((s = arguments), (o = this), (l = i), n)) {
                    if (h === r)
                      return (u = e = l), (h = nj(v, t)), p ? g(e) : c;
                    if (f) return iL(h), (h = nj(v, t)), g(l);
                  }
                ...
                return (
                  ...
                  sK(n) &&
                    ((p = !!n.leading),
                    (a = (f = "maxWait" in n) ? t5(s7(n.maxWait) || 0, t) : a),
                    (d = "trailing" in n ? !!n.trailing : d)),
                  (w.cancel = function () {
                    h !== r && iL(h), (u = 0), (s = l = o = h = r);
                  }),
                  (w.flush = function () {
                    return h === r ? c : m(sv());
                  }),
              ...
              var sx = ip(function (e, t) {
                  var r = (t =
                    1 == t.length && sL(t[0])
                      ? tp(t[0], tC(nu()))
                      : tp(rV(t, 1), tC(nu()))).length;
                  return ip(function (i) {
                    for (var n = -1, s = t6(i.length, r); ++n < s; )
              ...
              var sj = i2(rY),
                ...
                sq = r6(
                  ...
                  : function (e) {
                      return (
                        sF(e) && ej.call(e, "callee") && !e1.call(e, "callee")
                      );
                    },
                sL = em.isArray,
                sD = e8
              ...
              function sY(e) {
                return "string" == typeof e || (!sL(e) && sF(e) && rQ(e) == E);
              }
              function sX(e) {
                return "symbol" == typeof e || (sF(e) && rQ(e) == I);
              }
              var s0 = tn
                  ? tC(tn)
                  : function (e) {
              ...
              var oe = iK(function (e, t) {
                ...
                os = ip(function (e, t) {
                  ...
                  for (s && nE(t[0], t[1], s) && (n = 1); ++i < n; )
                    for (
                      var o = t[i], a = of(o), c = -1, h = a.length;
                      ++c < h;

                    ) {
                      var l = a[c],
                        u = e[l];
                      (u === r || (sN(u, eA[l]) && !ej.call(e, l))) &&
                        (e[l] = o[l]);
                    }
                  return e;
                }),
              ...
              function oP(e) {
                return (e = s8(e)) && e.replace(ep, tL).replace(eV, "");
              }
              ...
              function ok(e) {
                return r7("function" == typeof e ? e : rq(e, 1));
              }
              ...
              return (
                ...
                (rd.sampleSize = function (e, t, i) {
                  return (
                    ...
                    (sL(e)
                      ? function (e, t) {
                          return nD(iH(e), rT(t, 0, e.length));
                        }
                      : function (e, t) {
                          var r = o_(e);
                          return nD(r, rT(t, 0, r.length));
                        })(e, t)
                  );
                }),
                ...
                (rd.toPath = function (e) {
                  return sL(e) ? tp(e, nM) : sX(e) ? [e] : iH(nz(s8(e)));
                }),
                (rd.toPlainObject = s9),
                ...
                (rd.escape = function (e) {
                  return (e = s8(e)) && H.test(e) ? e.replace($, tD) : e;
                }),
                ...
                (rd.every = function (e, t, i) {
                  var n = sL(e) ? tc : r$;
                  return i && nE(e, t, i) && (t = r), n(e, nu(t, 3));
                }),
                (rd.find = sa),
                (rd.findIndex = nB),
                ...
                (rd.isEmpty = function (e) {
                  ...
                  for (var r in e) if (ej.call(e, r)) return !1;
                  return !0;
                }),
                ...
                (rd.isMatchWith = function (e, t, i) {
                  return (
                    (i = "function" == typeof i ? i : r), r2(e, t, nf(t), i)
                  );
                }),
                (rd.isNaN = function (e) {
                  return sZ(e) && e != +e;
                ...
                (rd.isSafeInteger = function (e) {
                  return (
                    sV(e) && e >= -9007199254740991 && e <= 9007199254740991
                  );
                }),
                (rd.isSet = sQ),
                (rd.isString = sY),
                ...
                (rd.lte = s5),
                (rd.max = function (e) {
                  return e && e.length ? rU(e, oM, rY) : r;
                }),
                ...
                (rd.min = function (e) {
                  return e && e.length ? rU(e, oM, r8) : r;
                }),
                ...
                (rd.repeat = function (e, t, i) {
                  return (
                    (t = (i ? nE(e, t, i) : t === r) ? 1 : s2(t)), iu(s8(e), t)
                  );
                }),
                (rd.replace = function () {
                  var e = arguments,
                ...
                (rd.size = function (e) {
                  if (null == e) return 0;
                  if (sz(e)) return sY(e) ? tV(e) : e.length;
                  var t = nv(e);
...
`) +
                ...
                (rd.truncate = function (e, t) {
                  ...
                  if (sK(t)) {
                    ...
                    (i = "length" in t ? s2(t.length) : i),
                      (n = "omission" in t ? iI(t.omission) : n);
                  }
                  var o = (e = s8(e)).length;
                  if (tM(e)) {
                    var a = tB(e);
                  ...
                  if ((a && (c += h.length - c), sJ(s))) {
                    if (e.slice(c).search(s)) {
                      var l,
                        u = h;
                      for (
                        s.global || (s = eP(s.source, s8(eo.exec(s)) + "g")),
                          s.lastIndex = 0;
                        (l = s.exec(u));
                ...
                ta(["drop", "take"], function (e, t) {
                  (rm.prototype[e] = function (i) {
                    ...
                    return (
                      n.__filtered__
                        ? (n.__takeCount__ = t6(i, n.__takeCount__))
                        : n.__views__.push({
                ...
                ta(["filter", "map", "takeWhile"], function (e, t) {
                  ...
                  rm.prototype[e] = function (e) {
                    var t = this.clone();
                    return (
                      t.__iteratees__.push({ iteratee: nu(e, 3), type: r }),
                ...
                (rs[iX(r, 2).name] = [{ name: "wrapper", func: r }]),
      ...
      var ix = Object.defineProperty,
        ...
        iT = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        iq = (e, t) => {
          for (var r in t || (t = {})) iN.call(t, r) && iT(e, r, t[r]);
          if (iC) for (var r of iC(t)) ij.call(t, r) && iT(e, r, t[r]);
          return e;
        },
        iL = (e, t) => iR(e, iA(t));
      function iD(e, t, r) {
      ...
      function ik(e) {
        ...
        for (let [a, c] of Object.entries(e)) {
          ...
          s[p] = iL(iq(iq({}, s[p]), c), {
            ...
            rpcMap: iq(iq({}, u), null == (n = s[p]) ? void 0 : n.rpcMap),
          });
        }
        return s;
      }
      ...
      class iK {
        constructor(e) {
          (this.name = "polkadot"),
            ...
            (this.events = iV("events")),
            (this.client = iV("client")),
        ...
        setDefaultChain(e, t) {
          this.httpProviders[e] || this.setHttpProvider(e, t),
            (this.chainId = e),
            this.events.emit(iP, `${this.name}:${e}`);
        }
        getAccounts() {
        ...
        createHttpProvider(e, t) {
          let r = t || iD(e, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new i_(new ib(r, iV("disableProviderPing")));
        }
      }
      class iF {
        constructor(e) {
        ...
        createHttpProvider(e, t) {
          let r =
            t ||
            iD(`${this.name}:${e}`, this.namespace, this.client.core.projectId);
          if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
          return new i_(new ib(r, iV("disableProviderPing")));
        }
        setHttpProvider(e, t) {
      ...
      class iZ {
        ...
        setDefaultChain(e, t) {
          this.httpProviders[e] || this.setHttpProvider(e, t),
            (this.chainId = e),
            this.events.emit(iP, `${this.name}:${this.chainId}`);
        }
        getAccounts() {
          let e = this.namespace.accounts;
          return e
      ...
      class iY {
        ...
        setDefaultChain(e, t) {
          if (((this.chainId = e), !this.httpProviders[e])) {
            let r = t || iD(`${this.name}:${e}`, this.namespace);
            if (!r) throw Error(`No RPC url provided for chainId: ${e}`);
        ...
        createHttpProvider(e, t) {
          let r = t || iD(e, this.namespace);
          return typeof r > "u"
            ? void 0
            : new i_(new ib(r, iV("disableProviderPing")));
        }
      }
      var iX = Object.defineProperty,
        ...
        i2 = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        i4 = (e, t) => {
          for (var r in t || (t = {})) i6.call(t, r) && i2(e, r, t[r]);
          if (i5) for (var r of i5(t)) i3.call(t, r) && i2(e, r, t[r]);
          return e;
        },
        i7 = (e, t) => i0(e, i1(t));
      class i9 {
        ...
        async createClient() {
          (this.client =
            ...
            (await io.init({
              logger: this.providerOpts.logger || iE,
              relayUrl:
        ...
        createProviders() {
          ...
          iB("client", this.client),
            iB("events", this.events),
            iB("disableProviderPing", this.disableProviderPing),
            e.forEach((e) => {
              if (!this.session) return;
              let t = (function (e, t) {
              ...
              switch (e) {
                case "eip155":
                  this.rpcProviders[e] = new iF({ namespace: i });
                  break;
                case "solana":
                  this.rpcProviders[e] = new iW({ namespace: i });
                  break;
                case "cosmos":
                  this.rpcProviders[e] = new iZ({ namespace: i });
                  break;
                case "polkadot":
                  this.rpcProviders[e] = new iK({ namespace: i });
                  break;
                case "cip34":
                  this.rpcProviders[e] = new iG({ namespace: i });
                  break;
                case "elrond":
                  this.rpcProviders[e] = new iJ({ namespace: i });
                  break;
                case "multiversx":
                  this.rpcProviders[e] = new iQ({ namespace: i });
                  break;
                case "near":
                  this.rpcProviders[e] = new iY({ namespace: i });
              }
            });
        }
        registerEventListeners() {
          ...
          this.client.on("session_ping", (e) => {
            ...
            this.client.on("session_event", (e) => {
              ...
              if ("accountsChanged" === r.name) {
                ...
                e &&
                  (0, o.qt)(e) &&
                  this.events.emit("accountsChanged", e.map(i$));
              } else if ("chainChanged" === r.name) {
                let e = t.chainId,
                  r = t.event.data,
                  i = (0, o.M)(e),
                  n = iU(e) !== iU(r) ? `${i}:${iU(r)}` : e;
            ...
            this.client.on("session_update", ({ topic: e, params: t }) => {
              ...
              (this.session = i7(i4({}, n), { namespaces: i })),
            ...
            this.client.on("session_delete", async (e) => {
              await this.cleanup(),
                ...
                this.events.emit(
                  "disconnect",
                  i7(i4({}, (0, o.D6)("USER_DISCONNECTED")), { data: e.topic })
                );
            }),
            this.on(iP, (e) => {
        ...
        persist(e, t) {
          this.client.core.storage.setItem(`${iI}/${e}`, t);
        }
        async getFromStore(e) {
          return await this.client.core.storage.getItem(`${iI}/${e}`);
        }
      }
      let i8 = ["eth_sendTransaction", "personal_sign"],
        ...
        nt = ["chainChanged", "accountsChanged"],
        nr = [
          "chainChanged",
          "accountsChanged",
          "message",
      ...
      var ni = Object.defineProperty,
        ...
        nh = (e, t, r) =>
          t in e
            ...
            : (e[t] = r),
        nl = (e, t) => {
          for (var r in t || (t = {})) na.call(t, r) && nh(e, r, t[r]);
          if (no) for (var r of no(t)) nc.call(t, r) && nh(e, r, t[r]);
          return e;
        },
        nu = (e, t) => nn(e, ns(t));
      function np(e) {
      ...
      class nd {
        ...
        async connect(e) {
          ...
          let { required: t, optional: r } = (function (e) {
            ...
            let h = {
                ...
                methods: i || i8,
                events: s || nt,
                rpcMap: nl({}, t.length ? { [np(t)]: c[np(t)] } : {}),
              },
              l = s?.filter((e) => !nt.includes(e)),
              u = i?.filter((e) => !i8.includes(e));
            if (
              !r &&
              !a &&
              !n &&
            ...
            let p = {
              chains: [
                ...new Set(
                  (l?.length && u?.length) || !r ? h.chains.concat(r || []) : r
                ),
              ],
              methods: [
                ...new Set(h.methods.concat(null != n && n.length ? n : ne)),
              ],
              events: [
                ...new Set(h.events.concat(null != a && a.length ? a : nr)),
              ],
              rpcMap: c,
            };
            return {
          ...
          try {
              ...
              this.rpc.showQrModal &&
                ...
                await this.signer
                  .connect(
                    nu(
                      nl(
                        { namespaces: nl({}, t && { [this.namespace]: t }) },
            ...
            this.setChainIds(this.rpc.chains.length ? this.rpc.chains : n),
              this.setAccounts(n),
              this.events.emit("connect", { chainId: nf(this.chainId) });
          } catch (e) {
        ...
        registerEventListeners() {
          this.signer.on("session_event", (e) => {
            ...
            this.signer.on("chainChanged", (e) => {
              let t = parseInt(e);
              (this.chainId = t),
                this.events.emit("chainChanged", nf(this.chainId)),
                this.persist();
            }),
            ...
            this.signer.on("session_delete", (e) => {
              this.reset(),
                ...
                this.events.emit(
                  "disconnect",
                  nu(nl({}, (0, o.D6)("USER_DISCONNECTED")), {
                    data: e.topic,
        ...
        getRpcConfig(e) {
          ...
          let o = i.length ? e?.methods || i8 : [],
            a = i.length ? e?.events || nt : [],
            c = e?.optionalMethods || [],
            h = e?.optionalEvents || [],
        ...
        async initialize(e) {
          if (
            ...
            (this.chainId = this.rpc.chains.length
              ? np(this.rpc.chains)
              : np(this.rpc.optionalChains)),
            (this.signer = await i9.init({
            ...
            if (e)
              try {
                this.modal = new e(
                  nl({ projectId: this.rpc.projectId }, this.rpc.qrModalOptions)
                );
              } catch (e) {
                throw (
    ...
    54098: function (e, t) {
      ...
      (function (e) {
        ...
        (w.polyfill = !0),
          i.fetch ||
            ((i.fetch = w), (i.Headers = c), (i.Request = g), (i.Response = v)),
          (e.Headers = c),
          (e.Request = g),
          (e.Response = v),
          (e.fetch = w),
      ...
      Object.defineProperty(s, "defaultMaxListeners", {
        ...
        (s.prototype.emit = function (e) {
          ...
          if ("function" == typeof c) i(c, this, t);
            ...
            for (var h = c.length, l = d(c, h), r = 0; r < h; ++r)
              i(l[r], this, t);
          return !0;
        }),
    ...
    72307: function (e, t, r) {
          ...
          (t = (function (e) {
            return null != e && eq(e.length) && !eT(e)
              ...
              : (function (e) {
                  if (
                    ((t = e && e.constructor),
                    e !== (("function" == typeof t && t.prototype) || k))
                  )
                    return ee(e);
                  var t,
                    r = [];
      ...
      function eS(e, t) {
        ...
        return !(!eL(r) || (V && V in r)) && (eT(r) ? K : I).test(eR(r))
          ? r
          : void 0;
      }
      ...
      var eC = e_(
          ...
          ? e_
          : function (e) {
              return eD(e) && H.call(e, "callee") && !G.call(e, "callee");
            },
        eN = Array.isArray,
        ej =
          X ||
      ...
      var ez = q
        ...
        : function (e) {
            return eD(e) && eq(e.length) && !!S[eb(e)];
          };
